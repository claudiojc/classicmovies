...
class ModelExtensionNews extends Model {	
	...
	public function getAllNews($data) {
		$sql = "SELECT * FROM " . DB_PREFIX . "news n LEFT JOIN " . DB_PREFIX . "news_description nd ON n.news_id = nd.news_id WHERE nd.language_id = '" . $this->config->get('config_language_id') . "' ORDER BY date_added DESC";
