...
<div id="content">
 ...
 <div class="buttons"><a onclick="$('#form').attr('action', '<?php echo $sort_submit; ?>'); $('#form').submit();" class="button"><?php echo $text_sort_order;?></a></div>
...
<td><input type="text" name="filter_order" value="<?php echo $filter_order; ?>" /></td>
...
<?php  $sort_order = "sort_order[". $product['product_id'] ."]"; ?>
        <td class="left"><input type="text"  size="5" name="<?php echo  $sort_order ?>"  value="<?php echo $product['sort_order']; ?>" /></td>
